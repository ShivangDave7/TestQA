...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      username: 'Eino.Marquardt',
      password: '4fdxOmhgGCDQWiw',
      email: 'Arjun_Volkman@gmail.com',
      name: 'John Towne',
      mobileNo: '1-836-398-8813 x58339',
      userType: 287,
      resetPasswordLink: {},
      loginRetryLimit: 577,
      loginReactiveTime: '2023-02-24T19:08:10.355Z',
      id: '6239511d0d27141a2e657cdf'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Keshawn_Johnston18',
        'password':'QJLXLpjDSLiqeHp',
        'email':'Ewald37@hotmail.com',
        'name':'Ms. Damon Deckow',
        'mobileNo':'801-223-7762',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Ewald37@hotmail.com', });
