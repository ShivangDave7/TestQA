...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      username: 'Kobe.Reichert19',
      password: '5RiHm0eMdShKPo5',
      email: 'Newton3@yahoo.com',
      name: 'Janice Auer',
      mobileNo: '988.967.3972 x57197',
      userType: 772,
      resetPasswordLink: {},
      loginRetryLimit: 26,
      loginReactiveTime: '2022-12-24T03:04:07.900Z',
      id: '6239511d0d27141a2e657cbe'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Johnson_Schmidt68',
        'password':'wcl9hfL643hSGcq',
        'email':'Verner.Legros@gmail.com',
        'name':'Ervin Harvey',
        'mobileNo':'(296) 547-5486 x8938',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Verner.Legros@gmail.com', });
